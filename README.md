...
| Skill | What It Does | Use When |
|-------|-------------|----------|
| [browser-ui-verification](skills/browser-ui-verification/SKILL.md) | Real-browser acceptance verification for rendered UI, user flows, console logs, network requests, and responsive layouts | After frontend or full-stack changes where user-visible behavior determines completion |
...
│   ├── browser-ui-verification/       #   Verify
